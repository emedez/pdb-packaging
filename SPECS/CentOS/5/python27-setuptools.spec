...
BuildRequires: python27, python27-libs
...
* Pull Request `#35 <https://bitbucket.org/pypa/setuptools/issue/35>`_: In `Buildout #64 <https://github.com/buildout/buildout/issues/64>`_, it was reported that
...
* Pull Request `#14 <https://bitbucket.org/pypa/setuptools/issue/14>`_: Honor file permissions in zip files.
...
while read line; do echo "\"$line\"" >> QUOTED_FILE_LIST; done < INSTALLED_FILES

%clean
rm -rf $RPM_BUILD_ROOT

%files -f QUOTED_FILE_LIST
%defattr(-,root,root)
